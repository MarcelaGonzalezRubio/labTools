function results = barGroupsold(SMatrix,params,groups,findMaxPerturb,plotFlag,indivFlag)
...
%         tmsteady1=[tmsteady1;nanmean(tmsteady1Data(1:transientNumPts,:))];   
...
%         tmsteady2=[tmsteady2;nanmean(tmsteady2Data((end-5)-steadyNumPts+1:(end-5),:))];      
         tmsteady2=[tmsteady2;nanmean(tmsteady2Data(1:transientNumPts,:))]; 
    end   
    
    %calculate relative after-effects
%     
    transfer=[transfer; 100*bsxfun(@rdivide,ogafter,tmcatch(:,3))];
    washout=[washout; 100*bsxfun(@rdivide,tmafter,tmcatch(:,3))];
...
%     washout=[washout; 100*(tmafter./tmcatch)];
    ...
    transfer2=[transfer2; 100*bsxfun(@rdivide,ogafter,tmsteady2)];
    washout2=[washout2; 100*bsxfun(@rdivide,tmafter,tmsteady2)];
