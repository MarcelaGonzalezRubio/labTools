...
% Last Modified by GUIDE v2.5 19-Jun-2015 14:25:24
...
for i=1:length(g)
load(handles.SMatrix.(g{i}).IDs{1,9})
...
handles = disableFields(handles,'groupList','subjectList','parameterList',...
    ...
    'exptLastNumPts','removeBiasCheck','printCodeCheck','colorMenu','saveColorsButton','BiofeedbackCheck');
...
switch get(eventdata.NewValue,'Tag')
    case 'timeCourseButton'
        ...
        handles = enableFields(handles,'groupList','subjectList','parameterList',...
            ...
            'indivSubs','binEdit','printCodeCheck','colorMenu','saveColorsButton','BiofeedbackCheck');
        for i=1:17
...
biofeedbackFlag=get(handles.BiofeedbackCheck,'Value');
...
% --- Executes on button press in BiofeedbackCheck.
function BiofeedbackCheck_Callback(hObject, eventdata, handles)
% Hint: get(hObject,'Value') returns toggle state of BiofeedbackCheck
end
