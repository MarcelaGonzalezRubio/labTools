...
biofeedback=get(handles.Biofeedback,'value');
adaptationData.plotAvgTimeCourse(adaptDataList,params,conds,binwidth,trialMarkerFlag,get(handles.indivSubs,'Value'),biofeedback,indivSubList);
end
...
% hObject    handle to Biofeedback (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
